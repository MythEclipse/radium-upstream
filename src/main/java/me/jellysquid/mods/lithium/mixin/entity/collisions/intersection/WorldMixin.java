...
/**
 * Replaces collision testing methods with jumps to our own (faster) entity
...
public abstract class WorldMixin implements WorldAccess {
    ...
    /**
     * Checks whether the area is empty from blocks, hard entities and the world
     * border.
    ...
    public boolean isSpaceEmpty(@Nullable Entity entity, Box box) {
        ...
        // If no blocks were collided with, try to check for entity collisions if we can
        // read entities
